...
_Generated: 2026-04-17T10:17:22.564Z_
...
Workspace `mcp.json` _(folder: worker-security-v6)_

- **c:\Users\user\Desktop\Work\worker-security-v6\.vscode\mcp.json** — _File missing_
